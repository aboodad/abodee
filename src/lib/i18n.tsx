...
const dict = {
  ...
  browse_luxury_fragrances: { ar: "تصفح تشكيلاتنا العطرية الفاخرة", en: "Browse our luxury fragrance collections" },
  view_all: { ar: "عرض الكل", en: "View all" },
  view_all_offers: { ar: "مشاهدة كل العروض", en: "View all offers" },
  most_popular_selection: { ar: "المختارات الملكية الأكثر طلباً", en: "Most requested royal selections" },
  visit_branches_title: { ar: "تفضل بزيارتنا في فروع هاشم للطيب", en: "Visit Hashem Lelteeb Branches" },
  visit_branches_desc: {
  ...
  view_branches_info: { ar: "عرض عناوين وأوقات عمل الفروع", en: "View branch addresses & working hours" },
  marquee: {
  ...
  offers_explore_desc: { ar: "تصفح جميع المنتجات والبخور والعطور الملكية المتوفرة في المتجر.", en: "Browse all available perfumes, incense and royal fragrances." },
  ...
  branches_updating_desc: { ar: "تواصل معنا عبر واتساب لمعرفة أقرب نقطة استلام.", en: "Contact us on WhatsApp for the nearest pickup point." },
  ...
  home_delivery_desc: { ar: "توصيل سريع لكافة المناطق (تُحسب التكلفة حسب الموقع)", en: "Fast delivery to all areas (cost based on location)" },
  pickup_from_branch: { ar: "استلام من الفرع (Pick up)", en: "Pick up from branch" },
  pickup_from_branch_desc: { ar: "استلام مجاني ومباشر من أحد فروع هاشم للطيب", en: "Free direct pickup from Hashem Lelteeb branches" },
  available_pickup_branches: { ar: "📍 فروع الاستلام المتاحة:", en: "📍 Available Pickup Branches:" },
  main_branch_pickup_info: { ar: "• الفرع الرئيسي — مسقط (يومياً من ٩ ص حتى ١٠ م).", en: "• Main Branch — Muscat (Daily from 9 AM to 10 PM)." },
  pickup_ready_notice: { ar: "سيتم تجهيز طلبك فور تأكيد الدفع وإبلاغك بجاهزية الاستلام عبر واتساب.", en: "Your order will be prepared upon payment confirmation and you will be notified via WhatsApp." },
  delivery_address_label: { ar: "عنوان وموقع التوصيل (المنطقة / الشارع / رقم المنزل)", en: "Delivery Address & Location (Area / Street / Building)" },
  ...
  bank_transfer_instruction: { ar: "يرجى تحويل مبلغ الطلب إلى الحساب البنكي التالي قبل أو فور إرسال رسالة الواتساب:", en: "Please transfer the order amount to the following bank account before or immediately upon sending the WhatsApp message:" },
  bank_label: { ar: "البنك", en: "Bank" },
  bank_proof_title: { ar: "إثبات التحويل البنكي (رقم الحوالة أو صورة الإشعار)", en: "Bank Transfer Proof (Reference or Receipt Image)" },
  bank_proof_desc: { ar: "راجع تفاصيل طلبك وحساب بنك مسقط، وأدخل رقم الحوالة أو صورة الإشعار ثم اضغط على زر إرسال الطلب.", en: "Review your order details and Bank Muscat info, enter reference or receipt photo, then click Submit." },
  receipt_attached_success: { ar: "تم إرفاق إشعار التحويل بنجاح", en: "Receipt image attached successfully" },
  ...
  footer_tagline: { ar: "فخامة العبير الملكي واللبان الحوجري الأصيل", en: "The luxury of royal fragrance and authentic Hojari luban" },
  quick_links: { ar: "روابط سريعة", en: "Quick Links" },
  payment_delivery: { ar: "طرق الدفع والتوصيل", en: "Payment & Delivery" },
  bank_transfer_muscat: { ar: "💳 التحويل البنكي (بنك مسقط)", en: "💳 Bank Transfer (Bank Muscat)" },
  payment_advance_note: { ar: "يتم الدفع مسبقاً لحساب المحل قبل إرسال الطلب.", en: "Payment must be made in advance before order dispatch." },
  delivery_pickup_title: { ar: "🚚 التوصيل والاستلام", en: "🚚 Delivery & Pickup" },
  delivery_pickup_desc: { ar: "التوصيل لجميع مناطق السلطنة ودول الخليج، أو الاستلام من فروعنا.", en: "Delivery across Oman and the GCC, or pick up from our branches." },
  ...
  auth_enter_email_password: { ar: "يرجى إدخال البريد الإلكتروني وكلمة المرور", en: "Please enter email and password" },
  ...
  auth_google_missing_id: { ar: "يتطلب تفعيل Google إدخال Client ID في لوحة تحكم Supabase", en: "Google sign-in requires configuring Client ID in Supabase" },
  auth_google_error: { ar: "تعذر الاتصال بمزود Google", en: "Could not connect to Google provider" },
  auth_google_connect_error: { ar: "حدث خطأ أثناء الاتصال بمزود Google", en: "Error connecting to Google provider" },
  ...
  // Checkout page
  checkout_enter_details: { ar: "أدخل بيانات التواصل الخاصة بك لإتمام وتسجيل الطلب.", en: "Enter your contact details to complete and register your order." },
  ...
  checkout_name_phone_required: { ar: "يرجى إدخال الاسم ورقم الهاتف للمتابعة", en: "Please enter name and phone to continue" },
  checkout_address_required: { ar: "يرجى كتابة عنوان التوصيل للمتابعة", en: "Please enter delivery address to continue" },
  checkout_address_placeholder: { ar: "مثال: مسقط — الخوير، شارع المها، بناية رقم 14", en: "e.g. Muscat — Al Khuwair, Al Maha St, Building 14" },
  ...
  checkout_notes_placeholder: { ar: "مثال: يرجى التوصيل بعد العصر، تغليف كهدية فاخرة...", en: "e.g. Please deliver after 4pm, gift wrapping..." },
  checkout_location_unavailable: { ar: "خدمة تحديد الموقع غير متوفرة في المتصفح", en: "Location service not available in this browser" },
  checkout_location_success: { ar: "تم تحديد إحداثيات موقعك بنجاح", en: "Your location coordinates detected successfully" },
  checkout_location_error: { ar: "تعذر تحديد الموقع تلقائياً", en: "Could not detect location automatically" },
  checkout_receipt_uploaded: { ar: "تم رفع صورة إشعار التحويل بنجاح", en: "Transfer receipt uploaded successfully" },
  checkout_receipt_upload_error: { ar: "فشل رفع صورة الإشعار", en: "Failed to upload receipt image" },
  checkout_receipt_uploading: { ar: "جاري رفع الإشعار...", en: "Uploading receipt..." },
  checkout_receipt_choose: { ar: "اختر صورة إشعار التحويل من جهازك", en: "Choose transfer receipt image from device" },
  checkout_receipt_alt: { ar: "إشعار التحويل", en: "Transfer receipt" },
  checkout_receipt_delete: { ar: "حذف الصورة", en: "Delete image" },
  checkout_transfer_placeholder: { ar: "مثال: TXN-89302194 / 10098432", en: "e.g. TXN-89302194 / 10098432" },
  checkout_transfer_ref: { ar: "رقم الحوالة / مرجع التحويل", en: "Transfer reference number" },
  checkout_receipt_image: { ar: "رفع صورة إشعار التحويل البنكي (اختياري)", en: "Upload bank transfer receipt (optional)" },
  ...
  checkout_order_error: { ar: "حدث خطأ أثناء تسجيل الطلب", en: "An error occurred while placing the order" },
  checkout_name_phone_error: { ar: "يرجى إدخال الاسم ورقم الهاتف", en: "Please enter name and phone number" },
  checkout_address_error: { ar: "يرجى إدخال عنوان التوصيل", en: "Please enter delivery address" },
  // Shop page
  search_placeholder: { ar: "ابحث عن عطر، بخور، لبان...", en: "Search for perfume, incense, luban..." },
