    ...
    return (
      <div className="mx-auto flex max-w-md flex-col px-4 py-16 sm:px-6">
        <div className="glass rounded-3xl p-8 text-center border border-border shadow-gold-glow space-y-5">
          ...
          <div>
            <h1 className="font-display text-xl font-bold text-foreground">{t("already_signed_in")}</h1>
            <p className="text-xs text-muted-foreground mt-1">{user.email}</p>
            {profile?.full_name ? (
              <p className="text-xs font-semibold text-primary mt-1">{t("welcome_user")}، {profile.full_name}</p>
            ) : null}
          </div>
    ...
    <div className="mx-auto flex max-w-md flex-col px-4 py-16 sm:px-6">
      <div className="glass rounded-3xl p-8 shadow-gold-glow border border-border/80">
        ...
        <div className="relative my-6 text-center">
          ...
          <span className="relative bg-card px-3 text-[11px] text-muted-foreground">{t("or_with_email")}</span>
        </div>
